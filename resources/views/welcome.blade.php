    ...
    <header class="bg-white">
        <nav class="flex items-center justify-between p-6 mx-auto max-w-7xl lg:px-8" aria-label="Global">
            ...
            <div class=" lg:flex lg:flex-1 lg:justify-end">
                @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/dashboard') }}" class="text-sm font-semibold leading-6 text-gray-900">Panel de Control <span aria-hidden="true">&rarr;</span></a>
                        @else
                ...
                <div class="p-6 lg:p-8">
                    <div class="lg:flex lg:items-center">
                        <div class="flex-shrink-0">
                            <img class="object-cover w-full" style="height: 300px;" src="{{ asset('images/banner.jpg') }}" alt="Banner">
                        </div>
                        <div class="mt-8 text-center lg:mt-0 lg:ml-8 lg:text-left">
                            ...
                            <a href="{{ url('/activar') }}" class="inline-block px-6 py-3 mt-6 font-semibold bg-gray-900 rounded-lg shadow-md text-red hover:bg-gray-700">Activar Giftcard</a>
                        </div>
                    </div>
                </div>
            </div>
